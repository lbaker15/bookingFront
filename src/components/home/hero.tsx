	...
	return (
		<div className="relative w-full overflow-hidden">
			<div ref={elementRef} className="h-screen">
				...
				<div
					ref={main}
					className="absolute h-[50vh] sm:h-[60vh]   bottom-0 w-full flex  items-end justify-center"
				>
					<img
						className="w-fit max-w-[80vw] h-full object-contain"
						src={acfFields.image.url}
						alt={acfFields.image.alt}
					/>
				</div>
